defmodule Day2 do
  ...
  #In game 1, three sets of cubes are revealed from the bag (and then put back again). The first set is 3 blue cubes and 4 red cubes; the second
  #set is 1 red cube, 2 green cubes, and 6 blue cubes; the third set is only 2 green cubes.
  #
  ...
  #impossible because at one point the Elf showed you 20 red cubes at once; similarly, game 4 would also have been impossible because the Elf showed
  #you 15 blue cubes at once. If you add up the IDs of the games that would have been possible, you get 8.
  #
  #Determine which games would have been possible if the bag had been loaded with only 12 red cubes, 13 green cubes, and 14 blue cubes. What is the sum
  ...
  defp convertLineToTuple line do
    [head | tail] = String.split(line, ": ")
    {String.replace(head, "Game ", ""), String.split(List.to_string(tail), "; ")}
  end

  defp formatInput input do
    list = String.split(input, "\n")
    Enum.map(list, fn line -> convertLineToTuple(line) end)
  end
